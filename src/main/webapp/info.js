...
window.setTimeout(function () {
    ...
    var infourl2 = "http://newpreapi.mogujie.com/h5/mwp.member.userinfo/1.5/?mw-appkey=100028&mw-t=1513912382677&mw-ttid=NMMain%40mgj_h5_1.0&data=%7B%22uid%22%3A%22185f5ks%22%2C%22appPlat%22%3A%22m%22%7D&mw-sign=91a82b1f7a588858246f629c26a1cf8b&callback=mwpCb2&_=1513912382678";
    var infourl = "http://api.mogujie.com/h5/mwp.mogulive.visitorIn4H5Service/1/?mw-appkey=100028&mw-t=1513937676389&mw-ttid=NMMain%40mgj_h5_1.0&mw-sign=8b95bcb74cc8316f8e47679bf7138770&data=%7B%22liveId%22%3A%221cbkeg%22%2C%22appPlat%22%3A%22h5%22%7D&callback=mwpCb2&_=1513937676391";
    ...
    xhrf.onreadystatechange = function () {
        console.log("----------------------------------------------"+xhrf.readyState);
        console.log("----------------------------------------------"+xhrf.status);
        if (xhrf.readyState == 4) {
            if (xhrf.status == 200) {
                var json = JSON.parse(xhrf.responseText);
